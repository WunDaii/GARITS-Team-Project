...
public class SelectFrame extends javax.swing.JFrame {
    ...
    public SelectFrame(PanelType type, ItemsInterface delegate) {
        initComponents();
        this.basePanel1.setupType(type);
        this.basePanel1.setDelegate(delegate);
        this.basePanel1.hideNonSelectButtons();
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        System.out.println("SelectFrame(PanelType type, ItemsInterface delegate)");
    ...
    private void initComponents() {
        ...
        basePanel1 = new Panels.BasePanel();
    ...
    private Panels.BasePanel basePanel1;
